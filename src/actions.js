...
export const getEvents = () => {
  return (dispatch) => {
    ...
    axios({
      url: `https://graph.facebook.com/v9.0/${process.env.GATSBY_FB_PAGE_ID}/events?fields=cover,name,description,ticket_uri,end_time,start_time,place&access_token=${process.env.GATSBY_FB_PAGE_ACCESS_TOKEN}`,
      method: "get",
    })
      .then((response) => {
